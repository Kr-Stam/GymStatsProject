...
class ReplaceExerciseAdapter(private val exercises: MutableList<ExerciseInfo>) :
    RecyclerView.Adapter<ReplaceExerciseAdapter.ExerciseViewHolder>() {
    ...
    fun setOnExerciseTapListener(listener: ((Int) -> Unit)) {
